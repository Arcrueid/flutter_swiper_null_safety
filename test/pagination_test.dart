...
void main() {
  testWidgets('Pagination', (WidgetTester tester) async {
    ...
    SwiperPluginConfig config =
        new SwiperPluginConfig(controller: controller, itemCount: 10, scrollDirection: Axis.horizontal);
    ...
    for (int i = 0; i < 10; ++i) {
      expect(find.byWidgetPredicate((Widget widget) {
        if (widget.key != null && widget.key is ValueKey && (widget.key as ValueKey).value == 'pagination_$i')
          return true;
  ...
  testWidgets('Pagination vertical', (WidgetTester tester) async {
    ...
    SwiperPluginConfig config =
        new SwiperPluginConfig(controller: controller, itemCount: 10, scrollDirection: Axis.vertical);
